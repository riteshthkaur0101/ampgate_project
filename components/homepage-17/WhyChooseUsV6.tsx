  ...
  return (
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
      <div className="container">
        <div className="mb-16 flex flex-col items-start justify-center gap-x-10 gap-y-4 md:flex-row lg:mb-24 lg:justify-between">
          <div className="md:w-[60%] md:self-start">
            <RevealWrapper className="rv-badge mb-2">
              <span className="rv-badge-text">Why Choose Ampgate</span>
            </RevealWrapper>
            <TextAppearAnimation>
              <h2 className="text-appear lg:leading-[1.1]">
                {serviceType === 'chatbots' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> AI Chatbots & Virtual Assistants </i>
                  </>
                )}
                {serviceType === 'workflow' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Workflow Automation </i>
                  </>
                )}
                {serviceType === 'ai-marketing' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> AI-Powered Marketing </i>
                  </>
                )}
                {serviceType === 'voice-ai' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Voice AI Solutions </i>
                  </>
                )}
                {serviceType === 'custom-ai' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Custom AI Development </i>
                  </>
                )}
                {serviceType === 'data-analytics' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Data Analytics &amp; BI </i>
                  </>
                )}
                {serviceType === 'app-dev' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Application Development </i>
                  </>
                )}
                {serviceType === 'process-automation' && (
                  <>
                    Why Choose Ampgate for
                    <i className="font-instrument"> Process Automation &amp; Optimization </i>
                  </>
                )}
                {!serviceType && (
                  <>
        ...
        <article>
          {/* First row of 3 cards with icons */}
          <RevealWrapper className="mb-[30px] flex flex-col gap-[30px] max-lg:flex-wrap md:flex-row">
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">{cards[0].title}</h5>
              <p className="text-base leading-[1.6]">{cards[0].description}</p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                {/* Icon 2 */}
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">{cards[1].title}</h5>
              <p className="text-base leading-[1.6]">{cards[1].description}</p>
            </RevealWrapper>
            <RevealWrapper className="flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                {/* Icon 3 */}
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">{cards[2].title}</h5>
              <p className="text-base leading-[1.6]">{cards[2].description}</p>
            </RevealWrapper>
          </RevealWrapper>
          {/* Second row of 2 cards with icons */}
          <RevealWrapper className="flex flex-col gap-[30px] md:flex-row">
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">{cards[3].title}</h5>
              <p className="text-base leading-[1.6]">{cards[3].description}</p>
            </RevealWrapper>
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
                {/* Icon 5 */}
              ...
              <h5 className="mb-2.5 mt-5 lg:text-[35px]">{cards[4].title}</h5>
              <p className="text-base leading-[1.6]">{cards[4].description}</p>
            </RevealWrapper>
          </RevealWrapper>
        </article>
      </div>
