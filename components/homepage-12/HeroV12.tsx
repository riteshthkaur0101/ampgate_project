      ...
      <div className="container">
        ...
        <TextAppearAnimation>
          <h1 className="text-appear text-center 2xl:leading-[1.21]">
            At Ampgate, we believe AI
            <i className="font-instrument"> isn't just technology— </i>
            it’s transformation.
          </h1>
        </TextAppearAnimation>
        <TextAppearAnimation>
          <p className="text-appear mx-auto mt-3 max-w-3xl text-center">
            We build intelligent systems that amplify human potential and accelerate business growth.
          </p>
        </TextAppearAnimation>
